...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(
                "\n"+" My name is "+ gosha.getName()+"\n"+
                " My mother name:"+gosha.getMother().getName()+"\n"+
                " My father name"+gosha.getFather().getName()+"\n"+
                " У меня две бабушки,бабушка "+gosha.getMother().getMother().getName()+
                " и " +gosha.getFather().getMother().getName()+ "\n"+
                " У меня два деда"+" дед "+gosha.getMother().getFather().getName()+" и "+gosha.getFather().getFather().getName());
    }
}
